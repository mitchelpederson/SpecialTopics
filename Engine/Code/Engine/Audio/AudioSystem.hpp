...
public:
	...
	virtual SoundPlaybackID		PlaySoundAtLocation( SoundID soundID, const Vector3& position, const Vector3& velocity, bool isLooped=false, float volume=1.f, float balance=0.0f, float speed=1.0f, bool isPaused=false );
	...
	virtual void				SetSound3DParameters( SoundPlaybackID playbackID, const Vector3& position, const Vector3& velocity );
